...
const NarrativeStepCard: React.FC<NarrativeStepCardProps> = ({ card, index }) => {
    ...
    return (
        ...
        >
            <InteractiveTilt className="h-full">
                <div
                    className={cn(
                        "group relative w-full h-full p-px rounded-[24px] overflow-hidden transition-all duration-500",
                        isFirst
                ...
                >
                    ...
                    >
                        ...
                        <div className="relative aspect-square rounded-xl overflow-hidden border border-white/10 mb-6 group-hover:border-white/20 transition-colors">
                            <img
                                src={card.image}
                                alt={card.title}
