...
const PhoneFrame: React.FC<PhoneFrameProps> = ({
  ...
  return (
    <div
      className="relative z-10 w-full max-w-[360px] aspect-[9/19] h-auto rounded-[48px] transition-all duration-700 hover:scale-[1.02] mx-auto shadow-[30px_30px_60px_-15px_rgba(0,0,0,0.1)] dark:shadow-[30px_30px_60px_-15px_rgba(0,0,0,0.3)]"
