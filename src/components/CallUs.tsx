        ...
        >
          <PhoneFrame currentTime={currentTime}>
            <div className="mb-8 text-center">
              {!isCalling && (
                <>
                  <SpotlightEffect className="w-16 h-16 bg-brand-primary/10 rounded-2xl mx-auto flex items-center justify-center mb-4 border border-brand-primary/20 shadow-[inset_0_1px_2px_rgba(255,255,255,0.2),inset_0_0_15px_rgba(255,255,255,0.1)]">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
